          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center max-w-4xl mx-auto">
              <div className="mb-8">
                <div className="inline-flex items-center space-x-2 bg-gray-800 px-4 py-2 rounded-full mb-6">
                  ...
                  <span className="text-sm font-medium text-yellow-400">
                    Custom Document-Trained Chatbots
                  </span>
                </div>
              </div>
              ...
              <p className="text-xl text-gray-300 mb-10 max-w-2xl mx-auto leading-relaxed">
                Upload PDFs, documents, spreadsheets. Your chatbot learns
                instantly and answers questions about your content. No coding
                required.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
                <Link
                  href="/login"
                  className="group bg-gradient-to-r from-yellow-400 to-yellow-300 text-black px-8 py-4 rounded-xl hover:from-yellow-500 hover:to-yellow-400 transition-all duration-200 flex items-center space-x-2 font-semibold"
                >
                ...
                <Link
                  href="/login"
                  className="border-2 border-gray-600 text-gray-300 px-8 py-4 rounded-xl hover:border-yellow-400 hover:text-yellow-400 transition-all duration-200 font-medium"
                >
                  View Demo
                </Link>
              </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-2xl mx-auto">
                Powerful features designed for businesses who want intelligent
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="group p-8 rounded-2xl bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 hover:shadow-xl hover:border-yellow-400 transition-all duration-300">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Upload PDFs, documents, and content. Your chatbot learns
                  instantly and answers questions accurately.
                </p>
              </div>
              ...
              <div className="group p-8 rounded-2xl bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 hover:shadow-xl hover:border-yellow-400 transition-all duration-300">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Advanced processing extracts text, images, and context from
                  any document type with precision.
                </p>
              </div>
              ...
              <div className="group p-8 rounded-2xl bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 hover:shadow-xl hover:border-yellow-400 transition-all duration-300">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Your chatbot understands context and provides accurate answers
        ...
        <section className="py-20 px-6 bg-gradient-to-r from-gray-900 to-black border-t border-b border-yellow-400">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Upload your content once and create chatbots that truly understand
              your business, documents, and knowledge base.
            </p>
            <Link
              href="/login"
              className="bg-yellow-400 text-black px-8 py-4 rounded-xl hover:bg-yellow-300 transition-colors font-semibold text-lg"
            >
        ...
        <footer className="py-12 px-6 bg-black text-white">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-gray-400">
              © 2025 ChatSmith. Built for the future of document-trained
              chatbots.
            </p>
          </div>
        </footer>
